...
{
    public class GetGroupedHousingsForLandlordHandler : BaseHousingHandler,IRequestHandler<GetGroupedHousingsForLandlordQuery, BaseResponse<OwnerHousingGroupedDto>>
    {
        
        public GetGroupedHousingsForLandlordHandler(IHousingService service) :base(service) { }

        public async Task<BaseResponse<OwnerHousingGroupedDto>> Handle(GetGroupedHousingsForLandlordQuery request, CancellationToken ct)
