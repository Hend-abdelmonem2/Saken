...
{
   public class SaveHousingHandler : BaseHousingHandler, IRequestHandler<SaveHousingCommand,BaseResponse<bool>>
    {

        public SaveHousingHandler(IHousingService service): base(service){}

        public async Task<BaseResponse<bool>> Handle(SaveHousingCommand request, CancellationToken ct)
